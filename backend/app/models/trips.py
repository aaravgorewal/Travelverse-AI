from sqlalchemy import Uuid, Column, String, Integer, JSON, ForeignKey, DateTime
...
class Trip(BaseModel):
    ...
    agent_id = Column(Uuid, ForeignKey("agents.id", ondelete="CASCADE"), index=True, nullable=True)
...
class TripDay(BaseModel):
    ...
    trip_id = Column(Uuid, ForeignKey("trips.id", ondelete="CASCADE"), index=True, nullable=False)
...
class Activity(BaseModel):
    ...
    trip_day_id = Column(Uuid, ForeignKey("trip_days.id", ondelete="CASCADE"), index=True, nullable=False)
